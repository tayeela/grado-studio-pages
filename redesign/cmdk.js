...
(function () {
  ...
  const COMMANDS = [
    { sec: "Инструменты", items: [
      ...
      { t: "Эквидистанта (параллельная копия)…", run: tool("offset"), available: () => toolEnabled("offset") },
    ...
    { sec: "Данные", items: [
      ...
      { t: "Точки по координатам (каталог из ГПЗУ, межевого плана)…", run: () => call("openCoordTable") },
